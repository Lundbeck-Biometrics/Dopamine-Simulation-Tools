...
print('\n With antagonist')
d2 = SomaFeedback( 10.0, [1e-2, 0.1], [10, 0.4], occupancy = [0, 1], efficacy = [0,0])
print('Occ:', d2.occupancy)
print('gain:', d2.gain())
...
print('\n With agonist')
d2 = SomaFeedback( 10.0, [1e-2, 0.1], [10, 0.4], occupancy = [0, 1], efficacy = [1,1])
print('Occ:', d2.occupancy)
print('gain:', d2.gain())
print('activation', d2.activity())
...
d2 = SomaFeedback( 10.0, [1e-2, 0.1], [10, 0.4], occupancy = [0, 0], efficacy = [1,1])
...
d2 = SomaFeedback( 10.0, [1e-2, 0.1], [10, 0.4], occupancy = [0, 0], efficacy = [1,0])
