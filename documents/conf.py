...
htmlhelp_basename = 'DopamineSimulationTooldoc'
...
latex_documents = [
    (master_doc, 'DopamineSimulationTool.tex', 'Dopamine Simulation Tool Documentation',
     'Jakob Kisbye Dreyer, Dept of Bioinformatics, H Lundbeck A/S', 'manual'),
]
...
man_pages = [
    (master_doc, 'dopaminesimulationtool', 'Dopamine Simulation Tool Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DopamineSimulationTool', 'Dopamine Simulation Tool Documentation',
     author, 'DopamineSimulationTool', 'One line description of project.',
     'Miscellaneous'),
]
